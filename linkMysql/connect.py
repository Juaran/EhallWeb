...
class EhallMysql(object):
    def __init__(self):
        """ 初始化 """
        self.connect_()  # 连接数据库
        self.db.select_db('EhallYNU')  # 选择ehall数据库

    def connect_(self):
        """ 连接数据库 """
        self.db = pymysql.connect(host=host, password=password)
        self.cursor = self.db.cursor()

        # 创建数据库
        sql = "CREATE DATABASE IF NOT EXISTS EhallYNU"
    ...
    def check_table(self):
        ...
        sql = """CREATE TABLE IF NOT EXISTS `Course` (
              ...
              `courses` varchar(25500) DEFAULT NULL
            ) ENGINE=InnoDB DEFAULT CHARSET=utf8;"""
        ...
        sql = """CREATE TABLE IF NOT EXISTS `Grades` (
                  `username` varchar(255) NOT NULL,
                  `term` varchar(255) DEFAULT NULL,
                  `grades` varchar(25500) DEFAULT NULL
                ) ENGINE=InnoDB DEFAULT CHARSET=utf8;"""
        ...
        sql = """CREATE TABLE IF NOT EXISTS `Exam` (
                  `username` varchar(255) NOT NULL,
                  `term` varchar(255) DEFAULT NULL,
                  `exams` varchar(25500) DEFAULT NULL
                ) ENGINE=InnoDB DEFAULT CHARSET=utf8;"""
